      ...
      <div className='border-b border-[#f1f1f1] w-full'>
         <nav className='w-full flex flex-row items-center px-5 py-1 justify-between'>
            <div className='flex flex-row items-center w-full'>
               <i className={`fa text-2xl mr-2 font-black ${mode ? 'text-[#FAFAF9]' : 'text-[#111111]'}`}>&#xf20e;</i>
               <p className={`text-2xl font-russ font-black uppercase ${mode ? 'text-[#f8f8f8]' : 'text-[#111111]'}`}>Twilight</p>
            </div>
            <div className='flex flex-row items-center justify-between w-[15%]'>
               <div className='flex flex-row items-center justify-center relative'>
                  <i className={`material-icons-outlined text-2xl ${mode ? 'text-[#FAFAF9]' : 'text-[#111111]'}`} title='notification'>
                     notifications
                  </i>
               </div>
               <div className='flex justify-center relative'>
                  <i className={`material-icons-outlined text-2xl ${mode ? 'text-[#FAFAF9]' : 'text-[#111111]'}`} title='mode'>
                     chats
                  </i>
               </div>
